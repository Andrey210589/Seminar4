...
#     Усложнение:
#     Создать список, где указанные числа будут стоять на соответствующих
# индексах,
...
# Дан список строк: ФИО + даты и суммы. 
# Типа клиент или продавец и его траты/счета. в виде дата:сумма
# Получить это в виде словаря: ключ-Кортеж ФИО, 
# значение-словарь поквартальная сумма для человека
# Тренируем/Изучаем:
